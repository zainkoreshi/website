...
export const aboutMe = {
  ...
  intro: "A penultimate student pursuing a Bachelors in Computer Science at HKBU. My primary skills are in front-end and back-end development. Aside from software development, I thoroughly enjoy reading, travelling, swimming, cycling and working on self development. Not to mention, I really enjoying trying out different cuisines and restaurants!",
}
